...
getindex('~/Desktop/coding+data/hasil_final/pps70/adb-70pps.csv','indexreal-adb-70pps.npy','indexsims-adb-70pps.npy')
getindex('~/Desktop/coding+data/hasil_final/pps70/dtc-70pps.csv','indexreal-dtc-70pps.npy','indexsims-dtc-70pps.npy')
getindex('~/Desktop/coding+data/hasil_final/pps70/gnb-70pps.csv','indexreal-gnb-70pps.npy','indexsims-gnb-70pps.npy')
getindex('~/Desktop/coding+data/hasil_final/pps70/knn-70pps.csv','indexreal-knn-70pps.npy','indexsims-knn-70pps.npy')
getindex('~/Desktop/coding+data/hasil_final/pps70/mlp-70pps.csv','indexreal-mlp-70pps.npy','indexsims-mlp-70pps.npy')
getindex('~/Desktop/coding+data/hasil_final/pps70/rfc-70pps.csv','indexreal-rfc-70pps.npy','indexsims-rfc-70pps.npy')
getindex('~/Desktop/coding+data/hasil_final/pps70/svmlin-70pps.csv','indexreal-svmlin-70pps.npy','indexsims-svmlin-70pps.npy')
getindex('~/Desktop/coding+data/hasil_final/pps70/svmrbf-70pps.csv','indexreal-svmrbf-70pps.npy','indexsims-svmrbf-70pps.npy')
