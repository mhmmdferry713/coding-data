...
def getresult(input, output, indices, indicess, name):
    ...
    #print(len(y_test))
    #print(len(indices))
    # y_sdn = np.take(y_sdn, indices)
    # y_test = np.take(y_test, indices)
...
getresult('/home/fauzi/low rate attack/result100pps/svmrbf.csv','svmrbf',id, ids, 'svmrbf')
getresult('/home/fauzi/low rate attack/result100pps/svmlin.csv','svmlin',id, ids, 'svmlin')
getresult('/home/fauzi/low rate attack/result100pps/knn.csv','knn',id, ids, 'knn')
getresult('/home/fauzi/low rate attack/result100pps/dtc.csv','dtc',id, ids, 'dtc')
getresult('/home/fauzi/low rate attack/result100pps/rfc.csv','rfc',id, ids, 'rfc')
getresult('/home/fauzi/low rate attack/result100pps/mlp.csv','mlp',id, ids, 'mlp')
getresult('/home/fauzi/low rate attack/result100pps/gnb.csv','gnb',id, ids, 'gnb')
getresult('/home/fauzi/low rate attack/result100pps/adc.csv','adc',id, ids, 'adc')
