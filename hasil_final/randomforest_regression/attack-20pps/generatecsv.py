...
generatecsv("adb-20pps.csv",data1)
generatecsv("dtc-20pps.csv",data2)
generatecsv("gnb-20pps.csv",data3)
generatecsv("knn-20pps.csv",data4)
generatecsv("mlp-20pps.csv",data5)
generatecsv("rfc-20pps.csv",data6)
generatecsv("svmlin-20pps.csv",data7)
generatecsv("svmrbf-20pps.csv",data8)
